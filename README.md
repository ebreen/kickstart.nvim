...
```sh
# on Linux and Mac
git clone https://github.com/ebreen/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```


```
# on Windows (cmd)
git clone https://github.com/ebreen/kickstart.nvim.git %userprofile%\AppData\Local\nvim\ 
```
